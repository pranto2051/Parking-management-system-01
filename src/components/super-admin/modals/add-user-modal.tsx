...
export function AddUserModal({ isOpen, onClose }: AddUserModalProps) {
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      title="Add New User"
      description="Create a new user account with the following information."
      maxWidth="lg"
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <Button type="submit" disabled={isLoading} className="bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-500/20 min-w-[120px]">
            {isLoading ? (
